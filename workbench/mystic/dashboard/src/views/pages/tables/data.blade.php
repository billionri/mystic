...
<head>
    ...
    <title>Mystic India | Dashboard</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{url('/dashboard')}}" class="logo">
            ...
            <span class="logo-mini"><b>Mys</b>tic</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>Mystic</b>India</span>
        </a>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        {{--            <li><a href="{{route ('pages.layout.simple')}}"><i class="fa fa-circle-o"></i> Simple tables</a></li>--}}
                        <li><a href="{{route ('pages.layout.data')}}"><i class="fa fa-circle-o"></i> Users</a></li>
                    </ul>
                </li>
  ...
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      ...
      <strong>Copyright &copy; 2014-2015 <a href="http://benowtechnology.com">Benow Technology</a>.</strong> All rights
      reserved.
  </footer>
...
<!-- page script -->
{{ HTML::script('/table/src/bootstrap-table.js') }}
<script>
//
